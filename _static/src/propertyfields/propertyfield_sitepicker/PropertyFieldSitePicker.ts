...
export interface _PropertyFieldSitePickerProperties extends PropertyFieldSitePickerProperties, IPropertyPaneCustomFieldProps {}

export default class PropertyFieldSitePicker implements IPropertyPaneField<PropertyFieldSitePickerProperties> {
